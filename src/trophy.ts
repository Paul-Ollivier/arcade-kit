 ...
 *  wide (20x18), so a consumer that forces it into a square box squashes it.
 *  Size it by one axis and derive the other from these. */
export const GOLD_CUP_SIZE = { w: 20, h: 18 } as const;

/** Resolved URL for the gold trophy cup (20x18 native) — the leaderboard's
